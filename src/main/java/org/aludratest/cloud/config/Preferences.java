...
public interface Preferences {
	...
	/**
	 * Returns the parent node of this preferences node, or <code>null</code> if this is the root node.
	 * 
	 * @return The parent node of this preferences node, or <code>null</code>.
	 */
